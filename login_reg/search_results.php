<?php 
	...
	$searchResults = getResults($_GET['query']);
	$jobs = $searchResults['documents'];
	...
	<div class="content_parent">
		<div class="pure-g main">
			<div class="pure-u-1-1">
		    	<h1 style="color: #9587bf; margin-bottom: 5px;">Search Results For <?php echo ucfirst($_GET['query']); ?></h1>
		    	<h1 style="color: #403858; margin-bottom: 60px; font-size: 18px;"><?php echo $searchResults['numFound'];?> Result(s) Found</h1>
			</div>
			<div class="pure-u-1-1">
				<?php
					foreach ($jobs as $job) {
